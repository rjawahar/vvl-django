...
function submitForm(){
	...
	var addressProof = idProofArray[0];
	
	console.log(idProofArray);
	...
	var dataObj = {
		...
		"fk_current_address_proof_type_id"	: addressProof["fk_id_proof_type_id"],//address_proof_type,
		"current_document_value"		: addressProof["id_proof_type"],
		"current_document_url"			: addressProof["alf_node_ref"],
		"current_address_fk_alf_node_ref"	: addressProof["alf_node_ref1"],
...
function submitCibilFailureForm(status){
	...
	var addressProof = idProofArray[0];
	console.log("memberNetworkArray",memberNetworkArray);
	console.log("memberFamilyArray",memberFamilyArray);
	console.log("businessStaffArray",businessStaffArray);
	console.log("memberAssetArray",memberAssetArray);
	console.log("idproofarray",idProofArray)
