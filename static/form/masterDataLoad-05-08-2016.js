...
var stringValidate	= ['firstname','father_name','dob','current_door_no','current_street_name','current_location_name','current_state',
				'id_proof_type','alf_node_ref','current_document_value','current_document_url','id1_name_as_per_bank_records',
				...
				'biz_location_name','biz_state','biz_address_fk_alf_node_ref','biz_address_fk_alf_node_ref1','biz_id_alf_node_ref','biz_issued_by','biz_no','biz_valid_upto','marital_status',
				'live_with', 'no_of_child_above17', 'no_of_child_below17','alf_node_ref1','current_address_fk_alf_node_ref'];
...
var intValidate   	= ['mobile_number','age','fk_curr_village_or_town_id','fk_id_proof_type_id','fk_current_address_proof_type_id','fk_bank_account_type_id1',
				...
				'brand_sale','nonbrand_sale', 'current_pincode' ];
