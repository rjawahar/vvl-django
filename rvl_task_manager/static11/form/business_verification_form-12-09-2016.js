...
$("#shop_photo_img").change(function(){
		document.getElementById('shop_photo_with_the_applicant').value = this.value;
...
function submitBvrForm(){
	...
	var stringValidate = ["biz_name_of_the_applicant","biz_name_of_the_firm","biz_name_of_the_proprietor","biz_ownership_of_the_premises","biz_nature_of_business",
				...
				"distributor_supplied_products","vfc_name_board_seen","distributor_type_of_sale","customer_behaviour","biz_landmark","distributor_name","distributor_address","name_of_the_person_spoken_to"];
	...
	var intValidate = ["biz_rentorlease_amount","biz_numberof_years_in_this_location","biz_products_sold","biz_business_turnover_per_day","biz_size_of_the_shop","biz_stock_level","biz_value_of_stock","bill_value_of_bills_collected",
			  "bill_period_from","bill_period_to","relationship_in_years","distributor_supplies_mon_avg","bill_number_of_days","distributor_phoneno",
			  "distributor_credit_period_in_days"];
	...
	console.log(biz_business_turnover_per_day);
	...
	var dataObj_bvr = {
		...
		"distributorReferenceArray":[{
						...
						"shop_photo_with_the_applicant"	: shop_photo_with_the_applicant.replace(/\\/g,'')
						}]
