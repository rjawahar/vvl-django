					...
					if( data.mlcompositeArray[0][arrayKeys[i]][j][objKeys[k]] || (data.mlcompositeArray[0][arrayKeys[i]][j][objKeys[k]] == 0) ){
						...
						if(arrayKeys[i] == "memberAssetArray"){
								if( data.mlcompositeArray[0][arrayKeys[i]][j]["member_asset_category"] != null){
									document.getElementById("fk_member_asset_type_id_"+(j+1)+'').innerHTML = data.mlcompositeArray[0][arrayKeys[i]][j]["member_asset_category"];
								}
								else{
									document.getElementById("fk_member_asset_type_id_"+(j+1)+'').innerHTML = "";
								}
						}
						if(arrayKeys[i] == 'idProofArray'){
							if(j && data.mlcompositeArray[0][arrayKeys[i]][j]["id_proof_type"] != "")
							{
								$('#id_proof_'+(j+1)).css('display','block');
							}
							if(document.getElementById(objKeys[k]+"_img_pop_"+(j+1)) && data.mlcompositeArray[0][arrayKeys[i]][j][objKeys[k]] != ""){
							...
							if(document.getElementById(objKeys[k]+'_'+(j+1)+'_img_pop_shop')){
								if(data.mlcompositeArray[0][arrayKeys[i]][j][objKeys[k]]){
									if(data.mlcompositeArray[0][arrayKeys[i]][j]["alf_node_ref"].indexOf("?alf_ticket=")  > -1){
										$('#'+objKeys[k]+'_'+(j+1)+'_img_pop_shop').attr("src", data.mlcompositeArray[0][arrayKeys[i]][j][objKeys[k]]);
									}
									else{
